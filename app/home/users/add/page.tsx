    ...
    <div className="flex h-screen bg-background">
      ...
      <main className="flex-1 overflow-auto">
        ...
        <Dialog open={showErrorDialog} onOpenChange={setShowErrorDialog}>
          <DialogContent className="bg-card border-border sm:max-w-md shadow-2xl">
            <DialogHeader>
              <DialogTitle className="text-destructive flex items-center gap-2 font-bold text-lg">
                <AlertCircle className="w-5 h-5 flex-shrink-0" />
                Submission Error
              </DialogTitle>
              <DialogDescription className="text-muted-foreground pt-3 text-sm leading-relaxed">
                {apiError}
              </DialogDescription>
            </DialogHeader>
            <div className="flex justify-end pt-4 border-t border-border mt-2">
              <button
                ...
                className="px-5 py-2 bg-muted hover:bg-muted/80 text-foreground rounded-lg text-sm font-semibold transition-colors"
              >
                Close
              </button>
            </div>
